...
$modversion['blocks'][$i]['show_func']   = "fontier_new_fonts_show";
$modversion['blocks'][$i]['edit_func']   = "fontier_new_fonts_edit";
...
$modversion['blocks'][$i]['show_func']   = "fontier_popular_fonts_show";
$modversion['blocks'][$i]['edit_func']   = "fontier_popular_fonts_edit";
$modversion['blocks'][$i]['options']     = "5|naming";
$modversion['blocks'][$i]['template']    = "fontier_popular_items.html";
++$i;
$modversion['blocks'][$i]['file']        = "popular_fonts_downloaded.php";
...
$modversion['blocks'][$i]['show_func']   = "fontier_popular_fonts_downloaded_show";
$modversion['blocks'][$i]['edit_func']   = "fontier_popular_fonts_downloaded_edit";
$modversion['blocks'][$i]['options']     = "5|naming";
$modversion['blocks'][$i]['template']    = "fontier_popular_fonts_downloaded.html";
++$i;
$modversion['blocks'][$i]['file']        = "last_fonts_viewed.php";
$modversion['blocks'][$i]['name']        = _MD_FONTIER_LAST_FONTS_VIEWED;
$modversion['blocks'][$i]['description'] = _MD_FONTIER_LAST_FONTS_VIEWED_DESC;
$modversion['blocks'][$i]['show_func']   = "fontier_last_fonts_viewed_show";
$modversion['blocks'][$i]['edit_func']   = "fontier_last_fonts_viewed_edit";
$modversion['blocks'][$i]['options']     = "5|naming";
$modversion['blocks'][$i]['template']    = "fontier_last_fonts_viewed.html";
++$i;
$modversion['blocks'][$i]['file']        = "last_fonts_downloaded.php";
...
$modversion['blocks'][$i]['show_func']   = "fontier_last_fonts_downloaded_show";
$modversion['blocks'][$i]['edit_func']   = "fontier_last_fonts_downloaded_edit";
$modversion['blocks'][$i]['options']     = "5|naming";
$modversion['blocks'][$i]['template']    = "fontier_last_fonts_downloaded.html";
// Templates
$i = 0;
$i++;
